...
1. Install Yarn - [See how to install Yarn](https://classic.yarnpkg.com/en/docs/install)
2. Install dependencies using `yarn install` command
3. Run `yarn start` command in the project root directory to run the app.
